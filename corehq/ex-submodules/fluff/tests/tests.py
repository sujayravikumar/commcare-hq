...
class FluffTest(TestCase):
    ...
    def test_indicator_classes(self):
        self.assertEquals(list(Indicators1._calculators.keys()), ['base0'])
        self.assertEquals(list(Indicators2._calculators.keys()), ['base1', 'base2'])
    ...
    def test_calculator_calculate(self):
        ...
        self.assertEquals(len(list(values.keys())), 8)
