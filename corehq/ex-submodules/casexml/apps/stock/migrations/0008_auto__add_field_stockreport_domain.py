...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'stock_stockreport', 'domain', self.gf('django.db.models.fields.CharField')(max_length=25, null=True), keep_default=False)
    ...
    models = {
        ...
        u'stock.stockreport': {
            ...
            'domain': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True'}),
