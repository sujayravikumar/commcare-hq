...
def _validate_fixture_upload(workbook):
    ...
    for table_number, table_def in enumerate(type_sheets):
        ...
        try:
            ...
            item_fields_list = list(data_item['field'].keys()) if 'field' in data_item else []
            ...
            item_attributes_list = list(data_item['property'].keys()) if 'property' in data_item else []
            ...
            for field in fields:
                if len(field.properties) > 0:
                    ...
                    if not isinstance(sheet_props, dict):
                        ...
                        continue
                    sheet_props_list = list(sheet_props.keys())
