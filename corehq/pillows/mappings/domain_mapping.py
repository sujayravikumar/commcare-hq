DOMAIN_INDEX="hqdomains_5svxko5q6uj3asia3vjc0j4qomj41p6e"
DOMAIN_MAPPING={'_meta': {'comment': 'Modified by Ethan 2014-03-28 for ElasticSearch 1.x syntax',
           'created': None},
 ...
 'properties': {'area': {'type': 'string'},
                ...
                'author': {'fields': {'exact': {'index': 'not_analyzed', 'type': 'string'}},
                           'type': 'string'},
                'billable_client': {'type': 'string'},
                'billing_address': {'dynamic': False,
                ...
                'deployment': {'dynamic': False,
                               'properties': {'city': {'fields': {'exact': {'index': 'not_analyzed', 'type': 'string'}},
                                                       'type': 'string'},
                                              'country': {'fields': {'exact': {'index': 'not_analyzed', 'type': 'string'}},
                                                          'type': 'string'},
                                              'date': {'format': "yyyy-MM-dd||yyyy-MM-dd'T'HH:mm:ssZZ||yyyy-MM-dd'T'HH:mm:ss.SSSSSS||yyyy-MM-dd'T'HH:mm:ss.SSSSSS'Z'||yyyy-MM-dd'T'HH:mm:ss'Z'||yyyy-MM-dd'T'HH:mm:ssZ||yyyy-MM-dd'T'HH:mm:ssZZ'Z'||yyyy-MM-dd'T'HH:mm:ss.SSSZZ||yyyy-MM-dd'T'HH:mm:ss||yyyy-MM-dd' 'HH:mm:ss||yyyy-MM-dd' 'HH:mm:ss.SSSSSS||mm/dd/yy' 'HH:mm:ss",
                                                       'type': 'date'},
                                              'description': {'fields': {'exact': {'index': 'not_analyzed', 'type': 'string'}},
                                                              'type': 'string'},
                                              'doc_type': {'index': 'not_analyzed',
                                                           'type': 'string'},
                                              'public': {'type': 'boolean'},
                                              'region': {'fields': {'exact': {'index': 'not_analyzed', 'type': 'string'}},
                                                         'type': 'string'}},
                               'type': 'object'},
                ...
                'internal': {'dynamic': False,
                             'properties': {'area': {'fields': {'exact': {'index': 'not_analyzed', 'type': 'string'}},
                                                     'type': 'string'},
                                            ...
                                            'initiative': {'fields': {'exact': {'index': 'not_analyzed', 'type': 'string'}},
                                                           'type': 'string'},
                                            'workshop_region': {'fields': {'exact': {'index': 'not_analyzed', 'type': 'string'}},
                                                           'type': 'string'},
                                            'notes': {'type': 'string'},
                                            'organization_name': {'fields': {'exact': {'index': 'not_analyzed', 'type': 'string'}},
                                                                  'type': 'string'},
                                            'phone_model': {'fields': {'exact': {'index': 'not_analyzed', 'type': 'string'}},
                                                            'type': 'string'},
                                            ...
                                            'sub_area': {'fields': {'exact': {'index': 'not_analyzed', 'type': 'string'}},
                                                         'type': 'string'},
                ...
                'ota_restore_caching': {'type': 'boolean'},
                ...
                'short_description': {'fields': {'exact': {'index': 'not_analyzed', 'type': 'string'}},
                                      'type': 'string'},
                ...
                'tags': {'type': 'string'},
                'title': {'fields': {'exact': {'index': 'not_analyzed', 'type': 'string'}},
                          'type': 'string'},
                'yt_id': {'type': 'string'}}}
